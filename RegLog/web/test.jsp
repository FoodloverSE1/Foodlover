...
<html lang="en">
	<head>
		...
		<title>Registrier dich jetzt!</title>
	...
	<body>
		<div class="container">	
                    <div align ="center"
                    <h2> Registrier dich schnell und einfach!</h2>
			<div id="bl-main" class="bl-main">
				<section>
					<div class="bl-box">
						<h2 class="bl-icon bl-icon-about">Kontakt</h2>
					</div>
					<div class="bl-content">
						...
						<p>
							<a href="https://tympanus.net/Development/ResponsiveMultiLevelMenu/"><strong>&laquo; Previous Demo</strong></a> |
							<a href="https://tympanus.net/codrops/?p=14783"><strong>Back to the Codrops Article</strong></a>
						</p>
					</div>
		...
		<script src="https://tympanus.net/codrops/adpacks/csscustom.js"></script> 
<script src="https://tympanus.net/codrops/wp-content/plugins/oiopub-direct/js.php?type=banner&align=center&zone=1"></script>
	</body>
</html>